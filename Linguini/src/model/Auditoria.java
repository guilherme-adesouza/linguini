 ...
 */
@Entity
@Table(name = "logged_actions", catalog = "linguini", schema = "audit")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Auditoria.findAll", query = "SELECT b FROM Auditoria b")
    , @NamedQuery(name = "Auditoria.findById", query = "SELECT b FROM Auditoria b WHERE b.id = :id")})
public class Auditoria implements Serializable {
    ...
    public Auditoria(Integer id, String schema_name, String table_name, Date action_tstamp, String action) {
        this.id = id;
    ...
    public Auditoria(Integer id, String schema_name, String table_name, String user_name, Date action_tstamp, String action, String original_data, String new_data, String query) {
        this.id = id;
        this.schema_name = schema_name;
        this.table_name = table_name;
