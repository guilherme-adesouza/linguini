...
public class TelaController implements Controller<Telas>{
    ...
    public void popularTabela(JTable tabela, String criterio, String ordenacao) {
        ...
        try {
            MensagemRetorno ms = this.telaDAO.consultarComCriterio(this.tabela, this.getCamposPesquisaveis(), criterio, ordenacao);
            if(ms.isSucesso()) {
        ...
        try {
            ...
            for (Object o : ms.getLista()) {
                ...
                dadosTabela[lin][0] = t.getId();
                dadosTabela[lin][1] = t.getTela();
                lin++;
            }
...
//                }
    ...
    private String[] getCamposPesquisaveis(){
        String[] campos = {"CAST(id AS text)", "tela"};
        return campos;
    }
    ...
    public List<CampoOrdenavel> getOrdenacao() {
        ...
        campos.add(new CampoOrdenavel("Tela", "tela"));
        return campos;
    }
    
    public void popularCombo(JComboBox combo){
        this.telaDAO.popularCombo("Telas", combo);
    }
}
